          ...
          <AnimatedSection delay={700} className="pt-8 md:pt-16">
            <div className="relative">
              <div className="aspect-video w-full max-w-5xl mx-auto overflow-hidden rounded-lg md:rounded-2xl shadow-xl md:shadow-2xl relative">
                <iframe
                  src="https://www.youtube.com/embed/1-IJrwTKVzE?si=SoLg5U558vH3Fh-7&autoplay=0&mute=0&controls=1&rel=0&modestbranding=1&enablejsapi=1&origin=https://mathssummercamp.org" 
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-transparent pointer-events-none z-0" />
              </div>
            </div>
          </AnimatedSection>
        </div>
